...
The Jewish calendar tries to create a situation where cycles of the lunar month produce a solar year.
...
More precisely: the average length of a lunar month[^1] is
[^1]: There is a whole separate system aimed at controlling the average month length to account for various religious constrains in the Jewish calendar. We will not get into that here.
...
lies in a strange creature called a *continued fraction*.[^2]  
[^2]: Continued fractions are often written compactly as $[a_0;\, a_1, a_2, a_3, \ldots]$, which saves space but hides the structure. I use the expanded tower notation throughout to keep the nested nature of the construction visible.
...
More than 100×.
With such a calendar we would get a drift of one day only after tens of thousands of years.
...
### The Jews Are the Best (Mathematically)
...
$12 \frac{123}{334}$ and $12 \frac{376}{1021}.$
